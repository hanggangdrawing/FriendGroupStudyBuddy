...
// All names, content, and scenarios are tailored to the group.
...
const findFriend = (id) => FRIENDS.find((f) => f.id === id) || FRIENDS[0];
...
const SEED_MESSAGES = [
  ...
  { id: "m9", author: "jhums",   time: "now",  text: "pomodoro starting in 5. who's joining?", system: false },
];
...
// ── Album ────────────────────────────────────────────────────────────────
// Photo placeholders with hue/tone for the grid.
const ALBUM = [
...
// ── Studying-now (for Pomodoro & Home presence) ──────────────────────────
const STUDYING_NOW = [
...
Object.assign(window, {
  AVATAR_COLORS, FRIENDS, initialsOf, findFriend,
  POSTS, SEED_MESSAGES, SEED_POLLS, DECKS, NOTES, ALBUM, STUDYING_NOW,
});
